    ...
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters">
                ...
                <el-form-item>
                    <el-button type="primary" v-on:click="getVirtualUsers">查询</el-button>
                </el-form-item>
                <el-form-item>
        ...
        <!--列表-->
        <el-table :data="virtualUsers" border highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
...
import { getVirtualUsersList, removeVirtualUser, batchRemoveVirtualUser, editVirtualUser, addVirtualUser } from '../../api/api';
...
export default {
    ...
    methods: {
        ...
        getVirtualUsers() {
            ...
            getVirtualUsersList(para).then((res) => {
                console.log('getVirtualUsersList res', res);
                this.total = res.data.dataLength;
                this.virtualUsers = res.data.data;
